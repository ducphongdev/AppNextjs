...
function Workspaces() {
  return (
    <div className="group py-2 px-3 cursor-pointer relative hover:bg-btn-tdp rounded-sm">
      ...
      <div className="hidden group-hover:block absolute top-[44px] left-0 w-[304px] z-50">
        ...
        <div className="flex flex-col bg-white dark:bg-[#1d2125] rounded-sm shadow-md">
          <h2 className="mt-4 mb-2 mx-5 font-semibold text-[12px] text-gray-600 dark:text-gray-300">
          ...
          <ul className="list-none pb-1">
            <li className="no-underline">
              ...
              >
                ...
                <p className="text-sm ml-3 font-normal text-gray-600 dark:text-gray-300">
